...
function Searcher({ search, setSearch, onAddClick }: SearcherProps) {
  return (
    <div className="flex gap-3 mb-4">
      ...
      <button
        onClick={onAddClick}
        className="bg-purple-500 text-white w-40 rounded-lg font-bold text-sm hover:bg-purple-700 transition-colors">
        + Add New
      </button>
    </div>
  )
