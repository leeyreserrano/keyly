...
- Encriptación de contraseñas de items

- Al cambiar la master contrasenya, se deberá de volver a encriptar todas las contraseñas del usuario en la bd con la nueva contraseña (JWT hecho)
